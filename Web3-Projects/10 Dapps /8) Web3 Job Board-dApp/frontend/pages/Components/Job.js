...
const AllJobs = () => {
  const {darkMode, indexData, setIndexData} = useGlobalContext();
  ...
  return (
    ...
    {job.map((job , index) => {
      return (<div onClick={()=>handleIndex(index)}>
        <div 
        className='flex flex-col justify-center p-6 bg-[#ebeef9] rounded dark:bg-[#222b44] dark:text-white my-4 '>
